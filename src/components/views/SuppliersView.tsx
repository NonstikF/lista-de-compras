...
const SupplierMapModal: React.FC<{
    ...
    const isUrl = activeLocation.startsWith('http');

    useEffect(() => {
        setCoords(null);
        setStatus('idle');
        if (!activeLocation.trim() || isUrl) return;
        setStatus('loading');
