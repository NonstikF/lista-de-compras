        ...
        >
                    ...
                    <Field label="Código de barras">
                        <div className="flex gap-2">
                            ...
                            <button
                                ...
                                className="shrink-0 px-3 rounded-xl bg-surface-container-low border border-outline-variant hover:bg-surface-container text-on-surface-variant hover:text-primary transition flex items-center justify-center"
                            >
                                <MIcon name="photo_camera" />
                            </button>
                        </div>
                    </Field>
            ...
            {scanning && (
                <BarcodeScannerModal
                    ...
                    onDetected={code => { update('barcode', code); setScanning(false); }}
                />
            )}
        </Modal>
    );
